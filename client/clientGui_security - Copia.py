...
"""def secureRegister(username, password):
...
def secureGetPassword(username, password):
    print "Username: " + username
    print "Password: " + password
    pwd = "volpe"
    return (True, pwd)

def secureDelete(username, website, password):
    print "Username: " + username
    print "Password: " + password

    return True

def secureUpdate(username, website, oldPass, newPass):
    print "Username: " + username
